...
// creating the canvas, and loading th eimages i used
function setup() {
...
//increases textcount by one which advances forward by 1 page
function ChangePage() {
  textCount = textCount + 1
}
//decreases textcount by 1 which goes back a page
function BackPage() {
  textCount = textCount - 1
}
//do not know what this does, but taking it out breaks my code sometimes.
function history() {
textSize(50);
...
//chooses the font, and advances the page
function draw() {
  background(background);
  //image(img, 1000, 200);
  textSize(80);
...
//the functionpage# defines what happens on each page
function page2() {
  createCanvas(windowWidth, windowHeight);
  background(background);
  textSize(50);
